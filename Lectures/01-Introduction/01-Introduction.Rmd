...
# Notes directory
dir_slides <- "~/GitHub/Intro_Econometrics_F19/Lectures/01-Introduction/"
# Knitr options
opts_chunk$set(
  comment = "#>",
  fig.align = "center",
...
[**Amna Javed**](https://kyleraze.com)

- Fourth year doctoral student in economics

- Development Economics and applied econometrician

- I study the economics of gender (early marriage and crime)
...
- Email: [.mono[amnaj@uoregon.edu]](mailto:amnaj@uoregon.edu) **(use EC 320 in the subject line)**
...
- Do income shocks affect __long term education outcomes__?
...
- Does building more schools increase __future wages__?
...
animate(gg, duration = 5, width = 10.5, height = 7)
anim_save("gganimate_L1.gif")
