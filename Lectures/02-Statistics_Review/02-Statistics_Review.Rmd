...
# Notes directory
dir_slides <- "~/GitHub/Intro_Econometrics_F19/Lectures/02-Statistics_Review/"
# Knitr options
opts_chunk$set(
  comment = "#>",
  fig.align = "center",
...
I'll post Problem Set 1 by Friday.

- Due on January 17th (next Friday) on Canvas.
- Includes both analytical and computational components.
